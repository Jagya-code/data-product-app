<!-- src/components/TableTreeView.vue -->
<template>
  <ul class="table-list">
    <li
      v-for="(table, index) in dataModel"
      :key="index"
...
const dataModel = store.dataModel
...
.table-list li:hover {
  background-color: #d6e2ed; /* soft hover */
}

.table-list li.selected {
  background-color: #c5d7e5; /* selected item */
  font-weight: 600;
}
</style>
